...
export const AnalysisTabs = ({
  ...
  return (
    <div className="flex flex-col items-center">
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4 w-full max-w-3xl">
        <div className="flex justify-center">
          <TabsList className="inline-flex justify-center space-x-1 overflow-x-auto bg-white">
        ...
        <TabsContent value="overview" className="mt-6">
          ...
          {/* Suggestions section directly in the Overview tab */}
