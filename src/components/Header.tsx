...
export const Header = () => {
  ...
  if (location.pathname === "/") {
    return <header className="border-b border-border bg-green backdrop-blur-sm sticky top-0 z-50">
  ...
  return <header className="border-b border-border bg-green backdrop-blur-sm sticky top-0 z-50">
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <Button className="bg-green-600 hover:bg-green-700 text-white flex items-center gap-2" onClick={() => setIsJournalWriteOpen(true)}>
      ...
      <JournalWritePopup isOpen={isJournalWriteOpen} onClose={() => setIsJournalWriteOpen(false)} onSubmitJournal={handleJournalSubmit} />
    </header>;
};
